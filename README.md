...
```bash
cd ~/Downloads && curl -fsSLO https://github.com/CyberAiAaron/tinghuitai-desktop/raw/main/tinghuitai-desktop-v0.5.1.zip && unzip -oq tinghuitai-desktop-v0.5.1.zip -d 听会台 && bash 听会台/安装.command
```
...
```bash
cd ~/Downloads && curl -fsSLO https://github.com/CyberAiAaron/tinghuitai-desktop/raw/main/tinghuitai-desktop-v0.5.1.zip && unzip -oq tinghuitai-desktop-v0.5.1.zip -d MeetingLiveMate && bash MeetingLiveMate/安装.command
```
