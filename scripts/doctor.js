...
const py=spawnSync(process.env.THT_PYTHON||'python3',['-c','import sys; assert sys.version_info >= (3,9)'],{encoding:'utf8'});if(py.status===0)check('Python 3.9+',true);else console.log('提示：Python 未就绪，可以录音转写；会后自动整理待安装 Python 3.9+ 后重试。');
